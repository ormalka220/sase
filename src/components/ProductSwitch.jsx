  ...
  return (
    ...
    >
      ...
      <button
        ...
        style={
          product === 'sase'
            ? { background: 'linear-gradient(135deg, #DC2626, #F97316)', boxShadow: '0 2px 8px rgba(220,38,38,0.4)' }
            : {}
        }
      >
        <ShieldCheck className="w-3.5 h-3.5" />
        <span className="hidden sm:inline">FortiSASE</span>
      </button>
      <button
        ...
        style={
          product === 'perception'
            ? { background: 'linear-gradient(135deg, #2563EB, #7C3AED)', boxShadow: '0 2px 8px rgba(37,99,235,0.4)' }
            : {}
        }
      >
