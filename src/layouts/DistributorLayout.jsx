        ...
        <div className="px-4 py-4 flex items-center gap-3 border-b border-white/5">
          ...
          {sidebarOpen && (
            <div className="min-w-0 leading-tight">
              <div className="font-black text-white text-sm tracking-tight">Distribution<span className="text-cdata-300"> Hub</span></div>
              <div className="text-[10px] text-cdata-500 font-medium">Distributor Portal</div>
            </div>
          )}
        </div>
        ...
        {sidebarOpen && (
          <div className="mx-3 mt-3 mb-1 p-3 rounded-xl bg-white/[0.03] border border-white/5">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-lg bg-cdata-500/15 border border-cdata-500/20 flex items-center justify-center flex-shrink-0">
                <Building2 className="w-3.5 h-3.5 text-cdata-300" />
              </div>
